"""granola-organizer: save Granola transcripts to markdown, filed by client."""
...
def cmd_install(args: argparse.Namespace) -> int:
    ...
    print("  Turn it off : granola-organizer uninstall")
    print("  Check it    : granola-organizer status")
...
def cmd_uninstall(_: argparse.Namespace) -> int:
    ...
    print("You can still file on demand with: granola-organizer poll --once")
    return 0
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="granola-organizer", description=__doc__)
