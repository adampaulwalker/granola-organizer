...
def daemon_started(interval: int) -> None:
    ...
    try:
        ...
        _atomic_write(HEALTH_FILE, {
            ...
            "generation": os.environ.get("GRANOLA_ROUTER_GENERATION"),
            "interval": interval,
...
def launch_agent_state() -> Dict[str, Any]:
    ...
    daemon_home = plist_env.get("GRANOLA_ROUTER_HOME")
...
def install_launch_agent(interval: int = 120,
    ...
    plist: Dict[str, Any] = {
        ...
        "EnvironmentVariables": {"GRANOLA_ROUTER_HOME": str(DATA_DIR),
                                 "GRANOLA_ROUTER_GENERATION": generation},
    }
